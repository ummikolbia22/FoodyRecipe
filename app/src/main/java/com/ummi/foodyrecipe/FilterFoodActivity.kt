...
import com.ummi.foodyrecipe.DetsilRecipeActivity.Companion.setWindowFlag
import com.ummi.foodyrecipe.adapter.FilterFoodAdapter
import com.ummi.foodyrecipe.api.Api
import com.ummi.foodyrecipe.model.ModelFilter
import com.ummi.foodyrecipe.model.ModelMain
...
class FilterFoodActivity : AppCompatActivity(), FilterFoodAdapter.onSelectData {
    ...
    override fun onSelected(modelMain: ModelFilter?) {
        val intent = Intent(this@FilterFoodActivity, DetsilRecipeActivity::class.java).also {
            it.putExtra("detailRecipe", modelMain)
            startActivity(it)
        }
    }
}